...
class EventController extends Controller
{
    ...
    public function getAllEvents() {
      ...
      public function createEvent(Request $request) {
        ...
        $event->time_of_event = $request->time_of_event ;
      ...
      public function updateEvent(Request $request, $id) {
        ...
        if (Event::where('id', $id)->exists()) {
            ...
            $event->added_by= is_null($request->added_by) ? $event->added_by: $request->added_by;
            $event->time_of_event= is_null($request->time_of_event) ? $event->time_of_event : $request->time_of_event;
            $event->link= is_null($request->link) ? $event->link: $request->link;
            $event->verified= is_null($request->verified) ? $event->verified: $request->verified;
            ...
            $event->user_type= is_null($request->user_type) ? $event->user_type: $request->user_type;
